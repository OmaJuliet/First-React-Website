...
import img from "../images/second.png";
        ...
        <section className="text-gray-600 relative">
            <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                ...
                <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                    <h2 className="text-gray-900 text-xl mb-1 font-medium text-Blue">Login</h2>
                    <form onSubmit={handleSubmit}>
                        ...
                        <p className="mt-6 text-underline">Don't have an account? {' '} <Link to="/" className="text-Blue underline decoration-2">Signup</Link></p>
                    </form >
                </div>
            </div>
        </section>
